...
router.patch("/orders/:orderId/cancel", authMiddleware(UserRole.customer), orderController.cancelOrder);
/* ADMIN */
router.get("/admin/orders", authMiddleware(UserRole.admin), orderController.getAllOrdersForAdmin);
router.patch("/admin/orders/:orderId/status", authMiddleware(UserRole.admin), orderController.updateOrderStatus);
router.patch("/admin/orders/:orderId/cancel", authMiddleware(UserRole.admin), orderController.cancelOrderByAdmin);
