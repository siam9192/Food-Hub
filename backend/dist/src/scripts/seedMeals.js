...
const rawData = [
    ...
    },
    {
        ...
        cat: "Grill & BBQ",
        diet: DietaryType.HALAL,
        img: "https://images.unsplash.com/photo-1598103442097-8b74394b95c6",
    },
    {
        name: "Butter Chicken",
        price: 420,
    ...
    },
    {
        ...
        cat: "Seafood",
        diet: DietaryType.HALAL,
        img: "https://images.unsplash.com/photo-1567137510738-9568285b7367",
    },
    {
        ...
        cat: "Breakfast",
        diet: DietaryType.HALAL,
        img: "https://images.unsplash.com/photo-1626132646529-500637532938",
    },
    {
        name: "Fish Tikka",
        price: 400,
        ...
        cat: "Appetizers",
        diet: DietaryType.HALAL,
        img: "https://images.unsplash.com/photo-1610057099443-fde8c4d50f91",
    },
    {
    ...
    },
    {
        ...
        cat: "Desserts",
        diet: DietaryType.HALAL,
        img: "https://images.unsplash.com/photo-1627998125066-1ed064166297",
    },
    {
        name: "Shahi Tukra",
        price: 120,
        ...
        cat: "Desserts",
        diet: DietaryType.HALAL,
        img: "https://images.unsplash.com/photo-1601205741712-b26145ee60a4",
    },
    {
        name: "Morog Polao",
        price: 380,
    ...
    },
    {
        ...
        cat: "Grill & BBQ",
        diet: DietaryType.HALAL,
        img: "https://images.unsplash.com/photo-1603360946369-dc9bb2258143",
    },
    {
        name: "Masala Chai",
        price: 60,
        ...
        cat: "Beverages",
        diet: DietaryType.HALAL,
        img: "https://images.unsplash.com/photo-1561336313-0bd5e0b27ec8",
    },
    {
        name: "Beef Rezala",
        price: 380,
...
async function main() {
    ...
    try {
        ...
        await Promise.all(rawCategories.map((name) => categoryService.createCategory({ name })));
        ...
        const meals = rawData
            ...
            if (!providerId || !categoryId) {
                console.warn(` Skipping "${item.name}" → Provider or Category not found`);
                return null;
            }
            return {
                name: item.name,
