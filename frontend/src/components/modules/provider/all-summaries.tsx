...
async function AllSummaries() {
  ...
  try {
    const res = await metaService.providerAllSummaries();
      ...
      {[
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            {stat.progress > 0 ? (
              <div className="flex items-center gap-1 text-[10px] font-black text-primary bg-emerald-500/5 px-2 py-1 rounded-lg">
