      ...
      <div className="w-full max-w-md bg-background rounded-[3rem] p-10 shadow-2xl text-center space-y-8">
        ...
        {status === "loading" && (
          <div className="space-y-6">
            ...
            <h1 className="text-3xl font-black italic uppercase">
              Verifying <span className="text-primary">Account</span>
            </h1>
        ...
        {status === "success" && (
          <div className="space-y-6">
            ...
            <h1 className="text-3xl font-black italic uppercase">
              Email <span className="text-primary">Verified</span>
            </h1>
            <p className="text-muted-foreground font-medium">
            ...
            <Button
              asChild
              className="w-full rounded-2xl font-black uppercase italic h-12"
            >
              <Link href="/login">
